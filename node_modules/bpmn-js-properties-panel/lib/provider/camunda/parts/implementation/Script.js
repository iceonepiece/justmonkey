...
module.exports = function(scriptLanguagePropName, scriptValuePropName, isFormatRequired) {
  ...
  template:
    ...
    isScriptResource: function(element, inputNode, btnNode, scopeNode) {
      var scriptType = domQuery('select[name=scriptType]', scopeNode);
      return scriptType.options[scriptType.selectedIndex].value === 'scriptResource';
    },

    isScript: function(element, inputNode,  btnNode, scopeNode) {
      var scriptType = domQuery('select[name=scriptType]', scopeNode);
      return scriptType.options[scriptType.selectedIndex].value === 'script';
    }
